# Appointment
Web application using SpringMVC,Spring Security, Spring data, JPA, MySql, JSP, Tile,Ajax, JQuery, javascript...
How to make the project work: 
	...
	5) deploy in Tomcat server (recommended Apache Tomcat 9+)
 	6) when the application start require 'Login' by Spring security
 			there are 2 users login: 
 				kimtey/123
 				admin/123

	PS: because I am using JQuery and bootstrap so to run you need to have internet connection. 